...
TARGET_DRAWINGS <- here("experiments/conceptviz_2/data/processed/by_item_means.csv")
DRAWING_DIRECTORY <- "data/raw/raw_human_drawings/full_simplified_"
OUTPATH_DIRECTORY <- "data/processed/tidy_human_drawings/"
