...
ggplot(lang.coun.coords, aes(lang.distance, mean)) +
  geom_point() +
  geom_smooth(formula = y~  x, method = "lm")
cor(lang.coun.coords$lang.distance, lang.coun.coords$mean)
ggplot(lang.coun.coords, aes(country.distance, mean)) +
  geom_point() +
  geom_smooth(formula = y~  x, method = "lm")
cor(lang.coun.coords$country.distance, lang.coun.coords$mean)
ggplot(lang.coun.coords, aes(log(lang.distance), mean)) +
  geom_point() +
  geom_smooth(formula = y~  x, method = "lm")
cor(log(lang.coun.coords$lang.distance), lang.coun.coords$mean)
ggplot(lang.coun.coords, aes(log(country.distance), mean)) +
  geom_point() +
  geom_smooth(formula = y~  x, method = "lm")
